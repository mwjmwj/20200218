            ...
            $scope.init = function(){
                ...
                for(let i in window.chineseList){
                    ...
                    for(let j in window.zodiac){
                        if(window.zodiac[j].name === i||i === window.zodiacList[window.zodiac[j].name]){
                            zodiacNum.push({num:window.zodiac[j].num,color:window.color.find(item => {return item.num == window.zodiac[j].num}).colorCode});
                        }
                    }
